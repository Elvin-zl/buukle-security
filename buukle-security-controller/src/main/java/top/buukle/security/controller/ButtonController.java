...
public class ButtonController {
    ...
    */
    ...
    public ModelAndView getPage(@PathVariable("pageName") String pageName, ButtonQuery query, ModelAndView modelAndView) throws Exception {
        modelAndView.addObject("response", buttonService.getPage(query));
        modelAndView.setViewName("button/" + pageName);
        return modelAndView;
    }
